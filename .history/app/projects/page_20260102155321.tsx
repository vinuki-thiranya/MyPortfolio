        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {filteredProjects.map((project, index) => (
              <motion.div
                key={project.id}
                className="group relative overflow-hidden bg-white dark:bg-[#112240] border border-[#e2e8f0] dark:border-[#1e2b47] shadow-lg hover:shadow-2xl transition-all duration-500 rounded-2xl cursor-pointer h-[480px] flex flex-col"
                initial={{ opacity: 0, y: 50 }}
