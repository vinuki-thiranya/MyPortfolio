        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {filteredProjects.map((project, index) => (
              <motion.div
                key={project.id}
                className="group relative overflow-hidden bg-white dark:bg-[#112240] border border-[#e2e8f0] dark:border-[#1e2b47] shadow-lg hover:shadow-2xl transition-all duration-500 rounded-2xl cursor-pointer h-[420px] flex flex-col"
                initial={{ opacity: 0, y: 50 }}
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  {/* Title */}
                  <h3 className="text-lg font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-3 line-clamp-2 group-hover:text-[#667eea] dark:group-hover:text-[#64ffd9] transition-colors duration-300 leading-tight min-h-[3.5rem]">
                    {project.title}
                  </h3>
                  
                  {/* Description - exactly 2 lines */}
                  <p className="text-[#4a5568] dark:text-[#a8b2d1] text-sm leading-5 mb-4 line-clamp-2 h-10">
                    {project.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6 min-h-[2.5rem]">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-[#f1f5f9] dark:bg-[#1e293b] text-[#334155] dark:text-[#cbd5e1] text-xs font-medium rounded-full border border-[#e2e8f0] dark:border-[#334155] hover:bg-[#667eea] hover:text-white dark:hover:bg-[#64ffd9] dark:hover:text-[#0a192f] transition-all duration-300"
                      >
                        {tech}
                      </span>
                    ))}
                    {project.technologies.length > 3 && (
                      <span className="px-3 py-1 bg-[#e2e8f0] dark:bg-[#334155] text-[#64748b] dark:text-[#94a3b8] text-xs font-medium rounded-full">
                        +{project.technologies.length - 3}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex gap-3 mt-auto">
                    <Link
                      ...
                      className="flex-1 inline-flex items-center justify-center px-4 py-3 bg-gradient-to-r from-[#667eea] to-[#764ba2] hover:from-[#5a67d8] hover:to-[#667eea] text-white text-sm font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg transform active:scale-95"
                    ...
                    <a
                      ...
                      className="flex-1 inline-flex items-center justify-center px-4 py-3 border-2 border-[#667eea] text-[#667eea] hover:bg-[#667eea] hover:text-white dark:border-[#64ffd9] dark:text-[#64ffd9] dark:hover:bg-[#64ffd9] dark:hover:text-[#0a192f] text-sm font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg transform active:scale-95"
                      onClick={(e) => e.stopPropagation()}
                    >
