        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {filteredProjects.map((project, index) => (
              <motion.div
                key={project.id}
                className="group relative overflow-hidden bg-white/70 dark:bg-slate-800/40 backdrop-blur-lg border border-white/20 dark:border-slate-700/50 shadow-lg hover:shadow-2xl transition-all duration-500 rounded-2xl cursor-pointer h-[480px] flex flex-col"
                initial={{ opacity: 0, y: 50 }}
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex gap-3 mt-auto">
                    <Link
                      ...
                      className="flex-1 inline-flex items-center justify-center px-4 py-3 bg-[#64ffd9] hover:bg-[#4fd1c7] text-[#0a192f] text-sm font-semibold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg transform active:scale-95"
