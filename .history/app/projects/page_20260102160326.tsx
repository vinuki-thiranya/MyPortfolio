            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col -mt-2">
                  {/* Title */}
                  <h3 className="text-lg font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-3 line-clamp-2 group-hover:text-[#667eea] dark:group-hover:text-[#64ffd9] transition-colors duration-300 leading-tight min-h-[3rem]">
                    {project.title}
                  </h3>
