        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {filteredProjects.map((project, index) => (
              <motion.div
                key={project.id}
                className="group relative overflow-hidden bg-white/80 dark:bg-[#1e1b4b]/60 backdrop-blur-md border border-[#e2e8f0]/50 dark:border-[#4c1d95]/30 shadow-lg hover:shadow-2xl transition-all duration-500 rounded-2xl cursor-pointer h-[480px] flex flex-col"
                initial={{ opacity: 0, y: 50 }}
