...
export default function AllProjects() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] to-[#e2e8f0] dark:from-[#0a192f] dark:to-[#0f172a] transition-colors duration-300">
            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div className="relative z-10 p-5 flex-1 flex flex-col justify-end">
                  {/* Title */}
                  <h3 className="text-2xl md:text-[28px] font-semibold text-white mb-3 line-clamp-2 group-hover:text-[#64ffd9] transition-colors duration-300 leading-tight min-h-[3rem] drop-shadow-lg">
                    {project.title}
                  </h3>
                  
                  {/* Description - exactly 2 lines */}
                  <p className="text-white/90 text-base leading-6 mb-4 line-clamp-2 h-12 drop-shadow-md">
                    {project.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4 min-h-[2.5rem]">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-white/30 text-white text-sm font-medium rounded-full backdrop-blur-md border border-white/50 hover:bg-[#64ffd9] hover:text-[#0a192f] transition-all duration-300"
                      >
                        {tech}
                      </span>
                    ))}
      ...
      {/* Back to Home Link */}
      <section className="pb-20 px-6 sm:px-12 md:px-16 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-7xl mx-auto">
          <motion.div
