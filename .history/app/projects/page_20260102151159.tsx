        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            {filteredProjects.map((project, index) => (
              <motion.div
                key={project.id}
                className="group relative overflow-hidden bg-white dark:bg-[#112240] border border-[#e2e8f0] dark:border-[#1e2b47] shadow-lg hover:shadow-2xl transition-all duration-500 rounded-2xl cursor-pointer"
                initial={{ opacity: 0, y: 50 }}
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="px-3 py-1 bg-[#64ffd9]/20 text-[#64ffd9] text-xs font-medium rounded-full border border-[#64ffd9]/30 backdrop-blur-sm">
                      {project.category}
                    </span>
                  </div>
                ...
                <div className="p-6 flex flex-col h-64">
                  <div className="flex-grow">
                    <h3 className="text-xl font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-3 line-clamp-2 group-hover:text-[#667eea] dark:group-hover:text-[#64ffd9] transition-colors duration-200 leading-tight">
                      {project.title}
                    </h3>
                    
                    <p className="text-[#4a5568] dark:text-[#a8b2d1] text-sm leading-6 mb-4 line-clamp-4">
                      {project.description}
                    </p>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4 min-h-[60px]">
                    {project.technologies.slice(0, 4).map((tech) => (
                      <span
                        key={tech}
                        className="px-3 py-1 bg-[#f7fafc] dark:bg-[#1a365d] text-[#2d3748] dark:text-[#e6f1ff] text-xs font-medium rounded-md whitespace-nowrap"
                      >
                        {tech}
                      </span>
                    ))}
                    {project.technologies.length > 4 && (
                      <span className="px-3 py-1 bg-[#f7fafc] dark:bg-[#1a365d] text-[#4a5568] dark:text-[#a8b2d1] text-xs font-medium rounded-md">
                        +{project.technologies.length - 4}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex gap-3 mt-auto">
                    <Link
                      ...
                      className="flex-1 inline-flex items-center justify-center px-4 py-3 bg-[#667eea] hover:bg-[#4c51bf] text-white text-sm font-semibold rounded-lg transition-all duration-300 hover:scale-105 shadow-md"
                    ...
                    <a
                      ...
                      className="flex-1 inline-flex items-center justify-center px-4 py-3 border-2 border-[#667eea] text-[#667eea] hover:bg-[#667eea] hover:text-white text-sm font-semibold rounded-lg transition-all duration-300 hover:scale-105"
                      onClick={(e) => e.stopPropagation()}
                    >
