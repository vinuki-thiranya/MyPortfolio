              ...
              <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/5 shadow-lg">
                <table className="min-w-full divide-y divide-white/10 text-left text-gray-200">
                  ...
                  <tbody className="divide-y divide-white/10">
                    {["Compiler Design", "Language Processing", "Code Generation", "C Programming", "Problem Solving"].map((area) => (
                      <tr key={area} className="bg-[#0a192f] even:bg-[#0a192f]/80">
                        <td className="px-6 py-4 font-semibold text-white/90">{area}</td>
                        <td className="px-6 py-4 text-gray-300">
                          {area === "Compiler Design" && "Strong understanding of lexer-parser pipelines"}
                          {area === "Language Processing" && "Hands-on DSL design experience"}
                          {area === "Code Generation" && "Reliable HTML output from high-level input"}
                          {area === "C Programming" && "Improved memory and structure management"}
                          {area === "Problem Solving" && "Systematic debugging and validation"}
                        </td>
                      </tr>
                    ))}
                  </tbody>
      ...
      <h2 className="text-5xl font-black mb-4">User Problems & Motivation</h2>
       <h3 className="text-2xl font-semibold text-white/90 mb-3"></h3>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                    This project strengthened practical understanding of:              </p>
