  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a192f] to-[#0a0f2a] text-white">
      ...
      <main className="pt-24 px-6">
        ...
        {/* Case Study Details */}
        {project.slug === "formlang-plus-plus" && (
          <section className="mb-20">
          <motion.div
        ...
        {project.slug === "auto-service-management-system" && (
          <section className="mb-20">
            <motion.div
            ...
            >
              <div>
                <p className="text-sm uppercase tracking-[0.4em] text-[#64ffd9] mb-4">Case Study</p>
                <h2 className="text-5xl font-black mb-4">Auto Service Spare Partsmm</h2>
                <p className="text-lg text-gray-300 leading-relaxed">
                  The Auto Service Spare Parts Management System is a secure, responsive platform built to modernize spare part operations for the auto service shop in Dambulla.
                  Developed as a group project at SLIIT, it pairs a sleek React frontend with a Spring Boot backend, focusing on authentication, role-based access, and mobile usability.
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="text-3xl font-semibold text-white/90">Introduction</h3>
                <p className="text-gray-300 leading-relaxed text-lg">
                  The application streamlines spare part management with secure, scalable workflows, centralized user control, and smooth collaboration between staff and administrators.
                  The team emphasized security, accessibility, and a clothesline of responsive design so every operation stays intuitive across devices.
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="text-3xl font-semibold text-white/90">Technologies</h3>
                <ul className="grid gap-2 text-gray-300 text-base">
                  <li><span className="font-semibold text-white/90">Frontend:</span> React.js, Tailwind CSS</li>
                  <li><span className="font-semibold text-white/90">Backend:</span> Java, Spring Boot, Spring Security</li>
                  <li><span className="font-semibold text-white/90">Authentication:</span> JWT (Access & Refresh Tokens)</li>
                  <li><span className="font-semibold text-white/90">Database:</span> MySQL</li>
                  <li><span className="font-semibold text-white/90">Project Management:</span> Jira</li>
                  <li><span className="font-semibold text-white/90">Version Control:</span> GitHub</li>
                </ul>
              </div>

              <div className="space-y-4">
                <h3 className="text-3xl font-semibold text-white/90">User Research & Pain Points</h3>
                <ul className="grid gap-2 text-gray-300 text-lg">
                  <li>No secure authentication or role-based access</li>
                  <li>Manual user handling without centralized control</li>
                  <li>Poor mobile usability</li>
                  <li>Undefined workflows for verification and password recovery</li>
                  <li>Risk of unauthorized administrative access</li>
                </ul>
              </div>

              <div className="space-y-4">
                <h3 className="text-3xl font-semibold text-white/90">My Role – Authentication & User Management</h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                  I drove the Authentication & User Management module: building Spring Boot services, designing JWT flows, creating email verification, and enabling admin-level user CRUD.
                </p>
                <ul className="grid gap-2 text-gray-300 text-lg">
                  <li>Implemented secure registration/login with JWT-based stateless authentication</li>
                  <li>Handled access and refresh token lifecycles</li>
                  <li>Integrated tokenized email verification and password reset flows</li>
                  <li>Enforced admin/staff role boundaries through Spring Security</li>
                  <li>Centralized exception handling for stable APIs</li>
                </ul>
              </div>

              <div className="space-y-4">
                <h3 className="text-3xl font-semibold text-white/90">Key Solutions Implemented</h3>
                  ...
                  <table className="min-w-full divide-y divide-white/10 text-left text-gray-200">
                    <thead className="bg-white/5 text-xs uppercase tracking-[0.4em] text-[#64ffd9]">
                      <tr>
                        ...
                        <th className="px-6 py-3">Solution Implemented</th>
              ...
              <div className="space-y-4">
                <h3 className="text-3xl font-semibold text-white/90">Technical Implementation & Results</h3>
                <p className="text-gray-300 text-lg leading-relaxed">
                  Spring Boot and Spring Security underpin the RESTful backend, JWT secures sessions, React + Tailwind handle the responsive frontend, and Jira tracks agile progress.
                </p>
                <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/5">
                  <table className="min-w-full divide-y divide-white/10 text-left text-gray-200">
                    <thead className="bg-white/5 text-xs uppercase tracking-[0.4em] text-[#64ffd9]">
                ...
                <p className="text-gray-400 text-sm">
                  This work reinforced secure full-stack development, emphasizing JWT security flows, agile teamwork, and clean system design for scalable applications.
                </p>
              </div>
            </motion.div>
          </section>
