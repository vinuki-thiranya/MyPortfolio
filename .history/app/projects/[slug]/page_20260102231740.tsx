        ...
        <section className="mb-20">
          <div className="max-w-4xl mx-auto text-left mb-16">
            <motion.div
              ...
              <motion.h1
                className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-tight text-white mb-5"
            ...
            >
                ...
                {project.title}
              <motion.p
                className="text-xl md:text-2xl text-[#64ffd9] font-semibold mb-8"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
