...
export default function ProjectPage({ params }: ProjectPageProps) {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br from-[#f8fafc] to-[#e2e8f0] dark:from-[#0a192f] dark:to-[#0f172a] transition-colors duration-300 ${playfair.variable} ${inter.variable}`}>
