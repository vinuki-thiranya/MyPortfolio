       ...
       <h3 className="text-2xl font-semibold text-white/90 mb-3"></h3>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                FORMLANG++ was implemented entirely in <b>C</b>, using <bFlex for lexical analysis and Bison for syntax parsing. The lexer identifies tokens such as form fields,
