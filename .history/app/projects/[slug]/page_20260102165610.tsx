      ...
      <section className="pt-32 pb-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <span className="text-[#667eea] dark:text-[#64ffd9] font-poppins text-sm font-semibold tracking-[2px] uppercase mb-4 block">
                Case Study 01
              </span>
              <h1 className="text-[#2d3748] dark:text-[#e6f1ff] text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight">
                {project.title}
              </h1>
              <h2 className="text-[#4a5568] dark:text-[#e6f1ff]/80 text-xl md:text-2xl font-light max-w-4xl mx-auto">
                {project.subtitle}
              </h2>
            </motion.div>
            ...
            >
              <Card className="p-6 border-none bg-white/80 dark:bg-[#112240]/80 backdrop-blur-lg shadow-lg">
                <h3 className="text-[#667eea] dark:text-[#64ffd9] font-semibold text-sm mb-2">Client</h3>
                <p className="text-[#2d3748] dark:text-[#e6f1ff] text-sm">{project.client}</p>
              </Card>
              <Card className="p-6 border-none bg-white/80 dark:bg-[#112240]/80 backdrop-blur-lg shadow-lg">
                <h3 className="text-[#667eea] dark:text-[#64ffd9] font-semibold text-sm mb-2">Type</h3>
                <p className="text-[#2d3748] dark:text-[#e6f1ff] text-sm">{project.type}</p>
              </Card>
              <Card className="p-6 border-none bg-white/80 dark:bg-[#112240]/80 backdrop-blur-lg shadow-lg">
                <h3 className="text-[#667eea] dark:text-[#64ffd9] font-semibold text-sm mb-2">Industry</h3>
                <p className="text-[#2d3748] dark:text-[#e6f1ff] text-sm">{project.industry}</p>
              </Card>
              <Card className="p-6 border-none bg-white/80 dark:bg-[#112240]/80 backdrop-blur-lg shadow-lg">
                <h3 className="text-[#667eea] dark:text-[#64ffd9] font-semibold text-sm mb-2">Role</h3>
                <p className="text-[#2d3748] dark:text-[#e6f1ff] text-sm">{project.role}</p>
              </Card>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36 bg-white/50 dark:bg-[#112240]/50 backdrop-blur-lg">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-8">Introduction</h2>
            ...
            {/* Technologies */}
            <div className="mt-12">
              <h3 className="text-xl font-semibold text-[#2d3748] dark:text-[#e6f1ff] mb-6">Technologies</h3>
      ...
      <section className="py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-8">Project Overview</h2>
            <div className="prose prose-lg max-w-none">
      ...
      <section className="py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36 bg-white/50 dark:bg-[#112240]/50 backdrop-blur-lg">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-8">User Problems & Motivation</h2>
            <div className="prose prose-lg max-w-none">
      ...
      <section className="py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-8">Key Solutions Implemented</h2>
      ...
      <section className="py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36 bg-white/50 dark:bg-[#112240]/50 backdrop-blur-lg">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-8">Technical Implementation</h2>
            <div className="prose prose-lg max-w-none">
      ...
      <section className="py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-8">Results & Learning Outcomes</h2>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse bg-white dark:bg-[#112240] rounded-lg shadow-lg overflow-hidden">
                <thead>
                  <tr className="bg-[#667eea] dark:bg-[#64ffd9] text-white dark:text-[#0a192f]">
      ...
      <section className="py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-8">Conclusion & Key Takeaways</h2>
            <div className="prose prose-lg max-w-none">
      ...
      <section className="py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36 bg-gradient-to-r from-[#667eea] to-[#764ba2] dark:from-[#64ffd9] dark:to-[#4fd1c7]">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white dark:text-[#0a192f] mb-6">
