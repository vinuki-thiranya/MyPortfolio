          ...
          >
            ...
            <div className="space-y-4">
              ...
              <ul className="grid gap-2 text-gray-500">
                <li className="flex items-start gap-3"><span className="text-[#64ffd9]">1. Lexical Analysis</span> – Tokenizing input source files</li>
                <li className="flex items-start gap-3"><span className="text-[#64ffd9]">2. Parsing</span> – Validating grammar and structure</li>
                <li className="flex items-start gap-3"><span className="text-[#64ffd9]">3. Abstract Syntax Tree Construction</span> – Representing form elements logically</li>
                <li className="flex items-start gap-3"><span className="text-[#64ffd9]">4. Semantic Validation</span> – Detecting logical and structural errors</li>
                <li className="flex items-start gap-3"><span className="text-[#64ffd9]">5. Code Generation</span> – Producing clean HTML5 output</li>
              </ul>
