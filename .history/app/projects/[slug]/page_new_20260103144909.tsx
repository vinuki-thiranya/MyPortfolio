          ...
          <div className="max-w-7xl mx-auto px-6 py-2">
            <div className="flex items-center justify-between text-sm">
              <div className="flex items-center space-x-6">
                <span className="text-[#64ffd9] font-medium">Project Details</span>
              ...
              <div className="flex items-center space-x-4">
                ...
                <button className="text-gray-300 hover:text-[#64ffd9] transition-colors">
          ...
          >
            <div className="flex items-center space-x-8">
              <Link href="/" className="flex items-center space-x-3">
                ...
                <span className="text-white font-medium hover:text-[#64ffd9] transition-colors">
                  VN Portfolio
                </span>
              </Link>
              ...
              <nav className="hidden md:flex items-center space-x-6">
                <Link href="/" className="text-gray-300 hover:text-[#64ffd9] transition-colors font-medium">
                  Home
                </Link>
                <Link href="/#about" className="text-gray-300 hover:text-[#64ffd9] transition-colors font-medium">
                  About
                </Link>
                <Link href="/#work" className="text-gray-300 hover:text-[#64ffd9] transition-colors font-medium">
                  Work
                </Link>
                <Link href="/projects" className="text-[#64ffd9] font-medium">
                  Projects
                </Link>
                <Link href="/#contact" className="text-gray-300 hover:text-[#64ffd9] transition-colors font-medium">
                  Contact
                </Link>
              </nav>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <Button 
                variant="ghost" 
                size="sm"
                className="text-gray-300 hover:text-[#64ffd9] hover:bg-white/5"
                asChild
              >
              ...
              <Button 
                variant="outline" 
                size="sm"
                className="border-[#64ffd9] text-[#64ffd9] hover:bg-[#64ffd9] hover:text-[#0a192f] bg-transparent"
                asChild
              >
        ...
        <div className="border-t border-white/5">
          <div className="max-w-7xl mx-auto px-6 py-3">
            <nav className="flex items-center space-x-2 text-sm">
              <Link href="/" className="text-gray-400 hover:text-[#64ffd9] transition-colors">
                Home
              </Link>
              <span className="text-gray-600">/</span>
              <Link href="/projects" className="text-gray-400 hover:text-[#64ffd9] transition-colors">
                Projects
              </Link>
              <span className="text-gray-600">/</span>
              <span className="text-[#64ffd9] font-medium">{project.title}</span>
            </nav>
          </div>
        </div>
      </header>
            ...
            <div className="max-w-6xl mx-auto px-6">
              ...
              >
                {project.images.map((img, index) => (
                  <div key={index} className="relative aspect-video rounded-xl overflow-hidden shadow-xl group">
                    <Image
                      src={img}
