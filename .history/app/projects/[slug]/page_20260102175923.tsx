...
export default function ProjectPage({ params }: ProjectPageProps) {
  ...
  <ul className="grid gap-3 text-gray-300 text-lg">
    <li className="flex items-start gap-4"><span className="text-[#64ffd9] font-semibold">1. Lexical Analysis</span> – Tokenizing input source files</li>
    <li className="flex items-start gap-4"><span className="text-[#64ffd9] font-semibold">2. Parsing</span> – Validating grammar and structure</li>
    <li className="flex items-start gap-4"><span className="text-[#64ffd9] font-semibold">3. Abstract Syntax Tree Construction</span> – Representing form elements logically</li>
    <li className="flex items-start gap-4"><span className="text-[#64ffd9] font-semibold">4. Semantic Validation</span> – Detecting logical and structural errors</li>
    <li className="flex items-start gap-4"><span className="text-[#64ffd9] font-semibold">5. Code Generation</span> – Producing clean HTML5 output</li>
  </ul>
