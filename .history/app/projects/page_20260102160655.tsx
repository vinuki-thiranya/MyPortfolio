                ...
                <div className="relative z-10 p-5 flex-1 flex flex-col justify-end">
                  ...
                  <div className="flex flex-wrap gap-1.5 mb-4 min-h-[2rem]">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span
                        key={tech}
                        className="px-2 py-0.5 bg-white/20 text-white text-xs font-medium rounded-full backdrop-blur-md border border-white/30 hover:bg-[#64ffd9] hover:text-[#0a192f] transition-all duration-300"
                      >
                        {tech}
                      </span>
                    ))}
                    {project.technologies.length > 3 && (
                      <span className="px-2 py-0.5 bg-white/20 text-white text-xs font-medium rounded-full backdrop-blur-md">
                        +{project.technologies.length - 3}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="flex gap-2.5">
                    ...
                    <a
                      ...
                      className="flex-1 inline-flex items-center justify-center px-3 py-2.5 bg-white/20 text-white hover:bg-white hover:text-[#0a192f] border border-white/30 text-xs font-semibold rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg transform active:scale-95 backdrop-blur-md"
                      onClick={(e) => e.stopPropagation()}
                    >
