      ...
      >
        ...
        <div className="flex items-center gap-8">
          ...
          <a 
            ...
            className="text-[#2d3748] dark:text-[#e6f1ff] hover:text-[#667eea] dark:hover:text-[#64ffd9] transition-colors duration-200"
            aria-label="LinkedIn"
          >
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="w-full max-w-[900px] px-4">
            <div className="tracking-normal leading-7 text-left">
              ...
              >
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-full overflow-hidden border-2 border-[#667eea] dark:border-[#64ffd9] flex-shrink-0">
                  <Image 
