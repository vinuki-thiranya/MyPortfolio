...
export default function AboutPage() {
  return (
    <div className={`${poppins.variable} ${robotoMono.variable} min-h-screen bg-[#f8fafc] dark:bg-[#0a192f] transition-colors duration-300 relative`}>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <Image
          ...
          alt="Background"
          fill
          className="object-cover opacity-[0.05] dark:opacity-[0.08] grayscale"
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#f8fafc] dark:to-[#0a192f]"></div>
      </div>
