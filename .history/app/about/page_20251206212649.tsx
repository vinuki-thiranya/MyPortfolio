  ...
  return (
    <div className={`${poppins.variable} ${robotoMono.variable} min-h-screen bg-[#f8fafc] dark:bg-[#0a192f] transition-colors duration-300`}>
      ...
      <section id="hero" className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0a192f] via-[#112240] to-[#0a192f]">
        <div className="container mx-auto px-12 md:px-16 lg:px-20 xl:px-24 2xl:px-32 h-screen flex items-center">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 xl:gap-24 items-center w-full max-w-7xl mx-auto">
            
            {/* Left Content */}
            <motion.div
              className="z-10 text-left lg:pr-8"
            ...
            >
              <div className="relative">
                {/* Decorative Elements */}
                <div className="absolute -top-4 -left-4 w-full h-full border-2 border-[#64ffd9]/30 rounded-2xl -z-10"></div>
                <div className="absolute -bottom-4 -right-4 w-full h-full bg-gradient-to-br from-[#64ffd9]/20 to-[#667eea]/20 rounded-2xl -z-20"></div>
                
                {/* Main Image Container */}
                <div className="relative w-80 h-96 lg:w-96 lg:h-[500px] rounded-2xl overflow-hidden border-4 border-white/10 shadow-2xl">
                  <Image
                  ...
                  <motion.div
                    className="absolute -top-6 -right-6 bg-[#0a192f]/90 backdrop-blur-sm border border-[#64ffd9]/30 rounded-xl p-4 shadow-xl"
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 0.6, delay: 1.3 }}
                  >
                    <div className="text-center">
                      <div className="text-2xl font-bold text-[#64ffd9]">6+</div>
                      <div className="text-xs text-gray-300">Projects</div>
                    </div>
                  </motion.div>
                  
                  <motion.div
                    className="absolute -bottom-6 -left-6 bg-[#0a192f]/90 backdrop-blur-sm border border-[#667eea]/30 rounded-xl p-4 shadow-xl"
                    initial={{ opacity: 0, scale: 0.8 }}
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 0.6, delay: 1.5 }}
                  >
                    <div className="text-center">
                      <div className="text-2xl font-bold text-[#667eea]">7+</div>
                      <div className="text-xs text-gray-300">Certificates</div>
                    </div>
                  </motion.div>
                </div>
              </div>
