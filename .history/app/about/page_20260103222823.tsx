...
export default function AboutPage() {
  return (
    <div className={`${poppins.variable} ${robotoMono.variable} min-h-screen bg-[#f8fafc] dark:bg-[#0a192f] transition-colors duration-300`}>
      ...
      <section id="hero" className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0a192f] via-[#112240] to-[#0a192f]">
        <div className="container mx-auto px-16 md:px-24 lg:px-32 xl:px-40 2xl:px-48 h-screen flex items-center">
          <div className="grid lg:grid-cols-2 gap-20 lg:gap-24 xl:gap-32 items-center w-full max-w-6xl mx-auto">
            ...
            {/* Right Content - Proper Side */}
            <motion.div
              className="relative z-10 grid grid-cols-2 gap-4 md:gap-6 lg:pl-8 xl:pl-12"
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              {/* Card 1: Education */}
              <motion.div 
                className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:border-[#64ffd9]/50 transition-all duration-300 group"
                whileHover={{ y: -5 }}
              >
                <div className="w-12 h-12 bg-[#64ffd9]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#64ffd9]/20 transition-colors">
                  <GraduationCap className="w-6 h-6 text-[#64ffd9]" />
                </div>
                <h3 className="text-white font-bold text-lg mb-1">Education</h3>
                <p className="text-gray-400 text-xs leading-relaxed">BSc in Computer Science @ SLIIT (2023-2027)</p>
              </motion.div>

              {/* Card 2: Experience */}
              <motion.div 
                className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl hover:border-[#667eea]/50 transition-all duration-300 group"
                whileHover={{ y: -5 }}
              >
                <div className="w-12 h-12 bg-[#667eea]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#667eea]/20 transition-colors">
                  <Code className="w-6 h-6 text-[#667eea]" />
                </div>
                <h3 className="text-white font-bold text-lg mb-1">Experience</h3>
                <p className="text-gray-400 text-xs leading-relaxed">Full-Stack Developer & UI/UX Enthusiast</p>
              </motion.div>
              ...
              >
                <div className="w-12 h-12 bg-[#64ffd9]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#64ffd9]/20 transition-colors">
                  <Award className="w-6 h-6 text-[#64ffd9]" />
                </div>
                <h3 className="text-white font-bold text-lg mb-1">Projects</h3>
                <p className="text-gray-400 text-xs leading-relaxed">6+ Successful Projects Completed</p>
              </motion.div>
              ...
              >
                <div className="w-12 h-12 bg-[#667eea]/10 rounded-xl flex items-center justify-center mb-4 group-hover:bg-[#667eea]/20 transition-colors">
                  <Award className="w-6 h-6 text-[#667eea]" />
                </div>
                <h3 className="text-white font-bold text-lg mb-1">Certificates</h3>
                <p className="text-gray-400 text-xs leading-relaxed">7+ Professional Certifications Earned</p>
              </motion.div>
            </motion.div>
      ...
      {/* Description Section */}
      <section id="description" className="py-20 bg-[#f8fafc] dark:bg-[#0a192f]">
      ...
      <section id="certificates" className="py-20 bg-[#f8fafc] dark:bg-[#0a192f]">
        <div className="max-w-4xl mx-auto px-6">
          <div className="w-full max-w-[900px] px-4">
            <div className="tracking-normal leading-7 text-left">
              <motion.div 
