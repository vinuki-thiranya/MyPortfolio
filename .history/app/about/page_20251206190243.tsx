...
export default function AboutPage() {
  return (
    <div className={`${poppins.variable} ${robotoMono.variable} min-h-screen bg-[#f8fafc] dark:bg-[#0a192f] transition-colors duration-300`}>
      ...
      {/* Hero Section */}
      <section id="hero" className="relative flex pt-32 pb-20 justify-center items-start min-h-screen overflow-hidden">
        {/* Background Image */}
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#0a192f]/80 via-[#0a192f]/60 to-[#0a192f]/80"></div>
        </div>
        
        <motion.div
          className="relative z-[9] w-full max-w-[900px] px-8 md:px-12 lg:px-4 mt-[100px] font-normal text-center"
        ...
        >
          <motion.h1
            className="text-5xl md:text-7xl lg:text-[80px] font-bold text-[#2d3748] dark:text-[#e6f1ff] mb-6 leading-tight"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.p
            className="text-lg text-[#4a5568] dark:text-[#e6f1ff]/70 font-poppins max-w-2xl mx-auto mb-12"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 1 }}
          >
            Discover more about my background, education, certifications, and technical expertise.
          </motion.p>
        </motion.div>
      </section>
