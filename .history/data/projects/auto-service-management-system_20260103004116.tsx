...
export const autoServiceProject: ProjectData = {
  ...
  caseStudy: {
    ...
    problemsIntro: "The auto service shop in Dambulla faced several operational challenges:",
    problemsMotivation: "Our solution addresses these challenges by implementing a comprehensive web-based platform that centralizes operations, enforces security, and provides a modern user experience across all devices.",
    solutions: {
      problem: [
