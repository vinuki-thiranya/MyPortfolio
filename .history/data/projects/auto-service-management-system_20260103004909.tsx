...
export const autoServiceProject: ProjectData = {
  ...
  caseStudy: {
    ...
    problemsIntro: "Before implementation, several key challenges were identified:",
    problemsMotivation: "These issues highlighted the need for a secure, scalable, and responsive system with strong access control and user management features.",
    solutions: {
      problem: [
