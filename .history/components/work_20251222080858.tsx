...
export default function Work() {
  ...
  return (
    <div id="work" className="bg-gradient-to-br from-[#0a192f] to-[#0f172a] min-h-screen relative">
      ...
      <div className="relative pt-20 pb-8 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          {projects.length > 0 && (
            <div
              ...
              data-scroll-section
              className={`project-card relative transition-opacity duration-500 ease-out ${
          ...
          <div className="space-y-8">
            {projects.slice(1).map((project, index) => (
              <div
                ...
                data-scroll-section
                className={`project-card sticky transition-opacity duration-300 ease-out ${
                ...
                style={{
                  ...
                  top: `${40 + index * 4}px`, // Minimal stacking offset - appears directly on first card
                  marginBottom: '60vh'
                }}
