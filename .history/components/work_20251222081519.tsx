          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <div
                ...
                style={{
                  zIndex: index === 0 ? 40 : 40 + index, // First card base layer, subsequent cards stack higher
                  top: index === 0 ? '200px' : `${200 + index * 8}px`, // First card below header, others stack with small offset
                  marginBottom: '60vh' // Consistent spacing for smooth scrolling
                }}
