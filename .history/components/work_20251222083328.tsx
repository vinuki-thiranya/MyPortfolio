            ...
            {projects.map((project, index) => (
              <div
                ...
                style={{
                  ...
                  top: '280px', // Position cards well below the header section
                  marginBottom: index === projects.length - 1 ? '20px' : '60vh' // Space for scrolling except last card
                }}
