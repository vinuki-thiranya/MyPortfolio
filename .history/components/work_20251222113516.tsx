...
export default function Work() {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      {
        threshold: 0.1, // Lower threshold for more responsive triggering
        rootMargin: "0px 0px -50px 0px", // Smaller margin for quicker transitions
      },
    )
            ...
            {projects.map((project, index) => (
              <div
                ...
                style={{
                  ...
                  marginBottom: '100vh' // Consistent spacing for all cards to ensure smooth scrolling
                }}
