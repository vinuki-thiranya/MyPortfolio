...
export default function Work() {
  // Filter out the last project for home page display
  const homePageProjects = projects.slice(0, -1) // Remove the last project
          ...
          <div className="space-y-8">
            {homePageProjects.map((project, index) => (
              <div
                ...
                } ${index === homePageProjects.length - 1 ? 'last-card-locked' : ''}`}
                style={{
                  ...
                  marginBottom: index === homePageProjects.length - 1 ? '200vh' : '30vh' // Much larger margin for last card
                }}
