            ...
            {projects.map((project, index) => (
              <div
                ...
                className={`project-card transition-all duration-500 ease-out ${
                  index === projects.length - 1 ? 'absolute' : 'sticky'
                } ${
                ...
                style={{
                  ...
                  top: index === projects.length - 1 ? '260px' : '260px', // All cards at same position
                  ...
                  marginBottom: index === projects.length - 1 ? '0' : '30vh' // No margin for absolute positioned last card
                }}
