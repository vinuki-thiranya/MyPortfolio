          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <div
                ...
                style={{
                  zIndex: index === 0 ? 30 : 30 + index, // First card lower, subsequent cards stack on top
                  top: index === 0 ? 'auto' : `${120 + (index - 1) * 8}px`, // First card static, others stack
                  marginBottom: index === 0 ? '60vh' : '60vh' // Consistent spacing
                }}
