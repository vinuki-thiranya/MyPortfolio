        ...
        <div className="max-w-5xl mx-auto px-4 pb-16">
          ...
          <div className="flex justify-between items-center mb-8">
            <motion.button
              ...
              className="group flex items-center justify-center w-12 h-12 bg-[#1a2332] hover:bg-[#64ffd9] border border-[#64ffd9]/30 hover:border-[#64ffd9] rounded-full transition-all duration-300 hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              whileTap={{ scale: 0.95 }}
            >
              <ChevronLeft className="w-6 h-6 text-[#64ffd9] group-hover:text-[#0a192f] transition-colors duration-300" />
            </motion.button>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <ChevronRight className="w-6 h-6 text-[#64ffd9] group-hover:text-[#0a192f] transition-colors duration-300" />
            </motion.button>
          </div>
          ...
          >
            <div className="relative overflow-hidden bg-white dark:bg-[#112240] border border-[#e2e8f0] dark:border-[#1e2b47] shadow-xl hover:shadow-2xl transition-all duration-500 rounded-2xl group cursor-pointer h-[400px]">
