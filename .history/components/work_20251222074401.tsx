          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <div
                ...
                style={{
                  zIndex: 40 - index, // Higher z-index for earlier cards (stack on top)
                  top: `${120 + index * 12}px`, // Start below fixed header with stacking
                  marginBottom: '60vh' // More space for smoother scrolling
                }}
