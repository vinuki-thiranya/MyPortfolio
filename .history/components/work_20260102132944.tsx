          ...
          <div className="relative h-[320px]">
            {projects.map((project, index) => {
              ...
              if (isActive) {
                ...
                // EXCEPT the last card - keep it at y=0 but hidden
                yPosition = isLastCard ? 0 : 100
                isVisible = false
              }

              return (
                isLastCard && isActive ? (
                  // Last card - completely static, no animations
                  <div
                    key={project.id}
                  ...
                  // All other cards - use motion.div with animations
                  <motion.div
                    key={project.id}
                    ref={(el) => { projectRefs.current[index] = el }}
                    data-project-id={project.id}
