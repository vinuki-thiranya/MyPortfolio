...
export default function Work() {
  ...
  return (
    <div id="work" className="bg-gradient-to-br from-[#0a192f] to-[#0f172a] py-8 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-[900px] mx-auto">
          {/* Section Heading */}
          <div>
            <motion.div 
              className="w-[250px] ml-[3px] border-b border-[#667eea] dark:border-[#e6f1ff] text-[#2d3748] dark:text-[#e6f1ff] font-poppins text-sm leading-8 font-semibold tracking-[2px] uppercase mb-3"
            ...
            <motion.h1 
              className="mt-1 mb-2 text-[#1a202c] dark:text-[#e6f1ff]/90 font-poppins text-4xl md:text-6xl lg:text-[70px] leading-[80px] font-semibold"
            ...
            <motion.h1
            className="motion-heading cursor-target hero-heading mt-0 mb-1 text-[#2d3748] dark:text-[#e6f1ff]/90 text-3xl md:text-5xl lg:text-[55px] leading-[35px] md:leading-[55px] lg:leading-[65px] font-black tracking-tight"
            ...
            <motion.p 
              className="w-full mb-4 text-[#4a5568] dark:text-[#e6f1ff]/70 font-poppins text-sm leading-6"
        ...
        <div className="max-w-5xl mx-auto px-4 pb-8">
          <div className="space-y-4">
            {projects.map((project, index) => (
              ...
              >
                <div className="relative overflow-hidden bg-white dark:bg-[#112240] border border-[#e2e8f0] dark:border-[#1e2b47] shadow-xl hover:shadow-2xl transition-all duration-500 rounded-2xl group cursor-pointer h-[350px]">
                  ...
                  <div className="absolute top-0 left-0 p-6 z-10 flex items-center gap-3">
                    <motion.h3
                  ...
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/80 to-black/60 flex flex-col justify-between p-6 z-20"
                    initial={{ opacity: 0 }}
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                      <div className="hidden lg:block">
                        ...
                        <motion.p
                          className="text-[#a8b2d1] mb-3 text-sm leading-relaxed line-clamp-3"
                          initial={{ y: 30, opacity: 0 }}
                          animate={{
                            y: hoveredProject === project.id ? 0 : 30,
                            opacity: hoveredProject === project.id ? 1 : 0,
                        ...
                        >
                          {project.technologies.slice(0, 4).map((tech) => (
                            <span
                              key={tech}
                              className="px-3 py-1 bg-[#64ffd9]/20 text-[#64ffd9] text-xs rounded-full border border-[#64ffd9]/30 backdrop-blur-sm"
                            >
                              {tech}
                            </span>
                          ))}
                      ...
                      >
                        <Link
                          ...
                          className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-[#64ffd9] hover:bg-[#4fd1c7] text-[#0a192f] font-medium text-sm rounded-lg transition-all duration-300 hover:scale-105"
                        ...
                        <a
                          ...
                          className="flex-1 inline-flex items-center justify-center px-4 py-2 border-2 border-[#64ffd9] text-[#64ffd9] hover:bg-[#64ffd9] hover:text-[#0a192f] font-medium text-sm rounded-lg transition-all duration-300 hover:scale-105 backdrop-blur-sm"
                          onClick={(e) => e.stopPropagation()}
                        >
