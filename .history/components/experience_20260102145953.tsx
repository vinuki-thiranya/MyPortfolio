...
export default function Experience() {
  ...
  return (
    <section className="flex py-[80px] justify-center items-center bg-white dark:bg-[#0a192f] transition-colors duration-300 min-h-screen">
      <div className="w-full max-w-[900px] px-4 text-left">
         <div className="tracking-normal leading-7">
