...
export default function Work() {
  ...
  return (
    <div id="work" className="bg-gradient-to-br from-[#0a192f] to-[#0f172a] min-h-screen relative">
      ...
      <div className="sticky top-0 z-50 bg-gradient-to-br from-[#0a192f] to-[#0f172a] pt-12 pb-6 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36 border-b border-[#1a365d]/30">
