...
export default function Work() {
  ...
  useEffect(() => {
    const handleWheel = (e: WheelEvent) => {
      ...
      // If we're at the last card, allow normal scroll to go to next section
      if (activeCardIndex === projects.length - 1 && e.deltaY > 0) {
        // Don't prevent default - let the section navigation handle it
        return
      }

      // If we're at the first card, allow normal scroll to go to previous section
      ...
      if (Math.abs(e.deltaY) > 30) {
        ...
        if (e.deltaY > 0) {
          ...
          if (activeCardIndex < projects.length - 1) {
            ...
            // At last card, allow scrolling to next section
