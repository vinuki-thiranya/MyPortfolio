            ...
            {projects.map((project, index) => (
              <div
                ...
                style={{
                  ...
                  // Lock last card in position - prevent it from moving up beyond 260px
                  ...(index === projects.length - 1 && {
                    position: 'sticky',
                    top: 'max(260px, 260px)', // Ensures it never goes above 260px
                    maxHeight: 'calc(100vh - 260px)' // Prevents overflow
                  })
                }}
