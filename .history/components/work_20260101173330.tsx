          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <div
                ...
                } ${index === projects.length - 1 ? 'last-card-locked' : ''}`}
                style={{
                  zIndex: index === 0 ? 30 : 30 + index, // First card base, subsequent cards stack higher
                  top: '260px', // All cards at same position for perfect stacking
                  marginBottom: index === projects.length - 1 ? '200vh' : '30vh' // Much larger margin for last card
                }}
