            ...
            {projects.map((project, index) => (
              <motion.div
                ...
                animate={{ 
                  ...
                  y: index === activeCardIndex ? 0 : 
                     (index === projects.length - 1 && activeCardIndex === projects.length - 1) ? 0 :
                     index < activeCardIndex ? -100 : 100,
                ...
                style={{ pointerEvents: index === activeCardIndex ? 'auto' : 'none' }}
              >
