            ...
            {projects.map((project, index) => (
              <div
                ...
                className={`project-card transition-all duration-500 ease-out ${
                  index === projects.length - 1 ? 'sticky' : 'sticky'
                } ${
                ...
                style={{
                  ...
                  // Last card gets fixed positioning once it reaches the stack position
                  ...(index === projects.length - 1 && visibleProjects.includes(project.id) && {
                    position: 'fixed',
                    top: '260px',
                    left: '50%',
