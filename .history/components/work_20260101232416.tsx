      ...
      >
        <div className="max-w-5xl mx-auto px-4 pb-16 relative">
          ...
          >
            ...
            {/* View All Projects Link - vertical */}
            <Link 
              href="/projects" 
              className="group inline-flex items-center gap-2 text-[#667eea] dark:text-[#64ffd9] font-poppins text-xs font-medium hover:text-[#4c51bf] dark:hover:text-[#4fd1c7] transition-colors duration-200 no-underline [writing-mode:vertical-lr] rotate-180"
            >
              View All Projects
              <ArrowUpRight className="w-3 h-3 group-hover:translate-x-1 transition-transform duration-200" />
            </Link>
          </motion.div>
        </div>
      </div>
