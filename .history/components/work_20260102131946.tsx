      ...
      <div className="sticky top-0 z-50 bg-gradient-to-br from-[#0a192f] to-[#0f172a] pt-12 pb-4 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-[900px] mx-auto">
          ...
          >
            <Link 
              href="/projects" 
              className="group inline-flex items-center gap-6 text-[#667eea] dark:text-[#64ffd9] font-poppins text-sm font-medium hover:text-[#4c51bf] dark:hover:text-[#4fd1c7] transition-colors duration-200 no-underline"
            >
              View All Projects
        ...
        <div className="max-w-5xl mx-auto px-4 pb-16 relative">
          ...
          <div className="relative h-[320px]">
            {projects.map((project, index) => {
              ...
              if (isActive) {
                // For last card, keep it fixed at center without movement
                if (isLastCard) {
                  yPosition = 0
                  isVisible = true
                } else {
                  // Other active cards animate to center
                  yPosition = 0
                  isVisible = true
                }
              ...
              return (
                <motion.div
                  ...
                  transition={isLastCard && isActive ? false : { 
                    duration: 0.6, 
