...
interface WorkProps {
  ...
  showProjectOnly?: number
}

export default function Work({ showHeaderOnly = false, showProjectOnly }: WorkProps) {
  ...
  // If showing header only, render just the header section
  if (showHeaderOnly) {
    return (
      <div className="bg-gradient-to-br from-[#0a192f] to-[#0f172a] py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36 min-h-screen flex items-center justify-center">
  ...
  // If showing a specific project only
  if (showProjectOnly !== undefined) {
    const project = projects[showProjectOnly]
      ...
      <div className="bg-gradient-to-br from-[#0a192f] to-[#0f172a] py-20 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36 min-h-screen flex items-center justify-center">
        <div className="max-w-[900px] mx-auto">
          <div className="max-w-5xl mx-auto px-4">
            <div
              key={project.id}
              className="project-card opacity-100 translate-y-0 scale-100"
