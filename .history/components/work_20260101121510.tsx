...
export default function Work() {
  ...
  return (
    <div id="work" className="bg-gradient-to-br from-[#0a192f] to-[#0f172a] min-h-screen relative">
      ...
      <div className="sticky top-0 z-50 bg-gradient-to-br from-[#0a192f] to-[#0f172a] pt-8 pb-3 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-[900px] mx-auto">
          <div>
            ...
            <motion.h1 
              className="mt-2 mb-1 text-[#1a202c] dark:text-[#e6f1ff]/90 font-poppins text-4xl md:text-6xl lg:text-[70px] leading-[80px] font-semibold"
            ...
            <motion.h1
            className="motion-heading cursor-target hero-heading mt-0 mb-1 text-[#2d3748] dark:text-[#e6f1ff]/90 text-3xl md:text-5xl lg:text-[60px] leading-[35px] md:leading-[55px] lg:leading-[70px] font-black tracking-tight"
        ...
        <div className="max-w-5xl mx-auto px-4 pb-12">
          ...
          <div className="flex justify-between items-center mb-6">
            <motion.button
              ...
              className="group flex items-center justify-center w-8 h-8 bg-[#1a2332] hover:bg-[#64ffd9] border border-[#64ffd9]/30 hover:border-[#64ffd9] rounded-full transition-all duration-300 hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed"
              ...
              whileTap={{ scale: 0.95 }}
            >
              <ChevronLeft className="w-4 h-4 text-[#64ffd9] group-hover:text-[#0a192f] transition-colors duration-300" />
            </motion.button>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
            >
              <ChevronRight className="w-4 h-4 text-[#64ffd9] group-hover:text-[#0a192f] transition-colors duration-300" />
            </motion.button>
          </div>
            ...
            <div className="relative overflow-hidden bg-white dark:bg-[#112240] border border-[#e2e8f0] dark:border-[#1e2b47] shadow-xl hover:shadow-2xl transition-all duration-500 rounded-2xl group cursor-pointer h-[350px]">
              ...
              <div className="absolute inset-0">
                {currentProject.image?.endsWith('.mp4') ? (
                  <video
                    ...
                    onLoadStart={() => console.log('Video started loading:', currentProject.image)}
              ...
              <div className="absolute top-0 left-0 p-8 z-10 flex items-center gap-4">
                <motion.h3
                  ...
                  initial={{ opacity: 1 }}
                  animate={{ opacity: hoveredProject === currentProject.id ? 0 : 1 }}
                ...
                <motion.div
                  ...
                  animate={{ 
                    opacity: hoveredProject === currentProject.id ? 0 : 1,
                    scale: hoveredProject === currentProject.id ? 0.8 : 1
                  }}
              ...
              <motion.div
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: hoveredProject === currentProject.id ? 1 : 0 }}
                transition={{ duration: 0.4, ease: "easeInOut" }}
                style={{ pointerEvents: hoveredProject === currentProject.id ? "auto" : "none" }}
              >
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <div className="hidden lg:block">
                    <motion.h3
                      ...
                      animate={{
                        y: hoveredProject === currentProject.id ? 0 : 30,
                        opacity: hoveredProject === currentProject.id ? 1 : 0,
                      }}
