...
export default function Work() {
  ...
  return (
    <div id="work" className="bg-gradient-to-br from-[#0a192f] to-[#0f172a] min-h-screen relative">
      ...
      <div className="sticky top-0 z-50 bg-gradient-to-br from-[#0a192f] to-[#0f172a] pt-8 pb-6 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-[900px] mx-auto">
          <div>
            ...
            <motion.h1
            className="motion-heading cursor-target hero-heading mt-0 mb-1 text-[#2d3748] dark:text-[#e6f1ff]/90 text-3xl md:text-5xl lg:text-[65px] leading-[40px] md:leading-[60px] lg:leading-[75px] font-black tracking-tight"
      ...
      <div ref={containerRef} className="relative px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-6xl mx-auto px-4 pb-16">
          {/* Project Card with Side Navigation */}
          <div className="flex items-center gap-6">
            {/* Single Project Card */}
            <motion.div
              key={currentProject.id}
              className="project-card flex-1"
            ...
            >
            <div className="relative overflow-hidden bg-white dark:bg-[#112240] border border-[#e2e8f0] dark:border-[#1e2b47] shadow-xl hover:shadow-2xl transition-all duration-500 rounded-2xl group cursor-pointer h-[360px]">
