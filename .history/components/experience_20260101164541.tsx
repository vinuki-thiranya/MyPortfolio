...
export default function Experience() {
  ...
  return (
    <section ref={sectionRef} className="flex py-[80px] justify-center items-center bg-white dark:bg-[#0a192f] transition-colors duration-300 min-h-screen relative" id="experience">
      ...
      <div className="fixed right-8 top-1/2 transform -translate-y-1/2 z-10">
        <div className="flex flex-col items-center">
          <div className="w-1 h-32 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
            <motion.div 
              className="w-full bg-[#667eea] dark:bg-[#64ffd9] rounded-full"
              style={{ height: `${scrollProgress * 100}%` }}
              transition={{ duration: 0.1 }}
            />
          </div>
          <span className="text-xs text-gray-500 dark:text-gray-400 mt-2 font-poppins">
      ...
      <div className="w-full max-w-[900px] px-4 text-center">
        ...
        {scrollProgress > 0.9 && (
          ...
          >
            <div className="flex flex-col items-center text-[#667eea] dark:text-[#64ffd9]">
              <span className="text-xs font-poppins mb-2">Ready for Skills & Tools</span>
              <motion.div
                animate={{ y: [0, 5, 0] }}
