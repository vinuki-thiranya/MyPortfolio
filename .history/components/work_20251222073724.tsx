          ...
          <div className="space-y-8">
            {projects.map((project, index) => (
              <div
                ...
                style={{
                  zIndex: index + 10, // Higher z-index for later cards (stack on top)
                  top: `${60 + index * 8}px`, // Increased stacking offset
                  marginBottom: '50vh' // Reduced space for smoother scrolling
                }}
