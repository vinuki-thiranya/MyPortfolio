...
export default function Work() {
  const [visibleProjects, setVisibleProjects] = useState<number[]>([1]) // Initialize with first project visible
  ...
  return (
    <div id="work" className="bg-gradient-to-br from-[#0a192f] to-[#0f172a] min-h-screen relative">
      ...
      <div className="sticky top-0 z-50 bg-gradient-to-br from-[#0a192f] to-[#0f172a] pt-20 pb-8 px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
      ...
      <div ref={containerRef} className="relative px-6 sm:px-10 md:px-14 lg:px-20 xl:px-28 2xl:px-36">
        <div className="max-w-5xl mx-auto px-4 pb-16">
          {/* First Project Card - Fixed Position */}
          {projects.length > 0 && (
            <div
              ref={(el) => { projectRefs.current[0] = el }}
              data-project-id={projects[0].id}
              data-scroll-section
              className={`project-card transition-all duration-500 ease-out ${
                visibleProjects.includes(projects[0].id)
              ...
              <div className="relative overflow-hidden bg-white dark:bg-[#112240] border border-[#e2e8f0] dark:border-[#1e2b47] shadow-xl hover:shadow-2xl transition-all duration-500 rounded-2xl group cursor-pointer h-[320px]">
                ...
                <div className="absolute inset-0">
                  {projects[0].image?.endsWith('.mp4') ? (
                    <video
                      ...
                      onLoadStart={() => console.log('Video started loading:', projects[0].image)}
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                    >
                      <source src={projects[0].image} type="video/mp4" />
                ...
                <div className="absolute top-0 left-0 p-8 z-10 flex items-center gap-4">
                  <motion.h3
                    ...
                    initial={{ opacity: 1 }}
                    animate={{ opacity: hoveredProject === projects[0].id ? 0 : 1 }}
                  ...
                  <motion.div
                    ...
                    animate={{ 
                      opacity: hoveredProject === projects[0].id ? 0 : 1,
                      scale: hoveredProject === projects[0].id ? 0.8 : 1
                    }}
                ...
                <motion.div
                  ...
                  initial={{ opacity: 0 }}
                  animate={{ opacity: hoveredProject === projects[0].id ? 1 : 0 }}
                  transition={{ duration: 0.4, ease: "easeInOut" }}
                  style={{ pointerEvents: hoveredProject === projects[0].id ? "auto" : "none" }}
                >
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    <div className="hidden lg:block">
                      <motion.h3
                        ...
                        animate={{
                          y: hoveredProject === projects[0].id ? 0 : 30,
                          opacity: hoveredProject === projects[0].id ? 1 : 0,
                        }}
                      ...
                      >
                        {projects[0].technologies.map((tech: string, techIndex: number) => (
                          <span
                            key={techIndex}
                            className="px-4 py-2 bg-[#64ffd9]/10 border border-[#64ffd9]/30 rounded-full text-[#64ffd9] text-sm font-medium backdrop-blur-sm"
                          >
                            {tech}
                          </span>
                        ))}
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    >
                      <a
                        ...
                        className="inline-flex items-center gap-2 px-6 py-3 bg-[#64ffd9]/20 border border-[#64ffd9]/40 rounded-lg text-[#64ffd9] font-medium hover:bg-[#64ffd9]/30 transition-all duration-200 backdrop-blur-sm"
                      >
                    ...
                    >
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-[#a8b2d1]/20 border border-[#a8b2d1]/40 rounded-lg text-[#a8b2d1] font-medium hover:bg-[#a8b2d1]/30 transition-all duration-200 backdrop-blur-sm"
                      >
          ...
          {/* Stacking Cards Container - For cards 2 onwards */}
          <div className="space-y-8">
            {projects.slice(1).map((project, index) => (
              <div
                ...
                data-scroll-section
                className={`project-card sticky transition-all duration-500 ease-out ${
                  visibleProjects.includes(project.id)
                    ? "opacity-100 translate-y-0 scale-100"
                    : "opacity-0 translate-y-32 scale-90"
                }`}
                style={{
                  zIndex: 31 + index, // Stack on top of first card
                  top: `${120 + index * 8}px`, // Stack with slight offset
                  marginBottom: '60vh'
                }}
