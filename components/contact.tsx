  ...
  return (
    <section className="pt-[150px] pb-[50px] bg-[#0a192f] relative" id="contact">
      <div className="max-w-[900px] mx-auto px-4">
        ...
        {/* Footer */}
        <motion.div
          className="flex mt-[200px] justify-between items-end"
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* Right Email */}
      <motion.div
        className="fixed right-12 bottom-0 z-[9] flex justify-end items-center flex-row"
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      {/* Webflow Badge */}
      <div className="absolute bottom-4 right-4 z-20"></div>
    </section>
  )
}
